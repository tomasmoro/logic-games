 ...
 *
 * Define las tres piezas del ciclo unidireccional (ver [com.example.kortexgames.core.mvi.MviViewModel]):
...
sealed interface NeonPulseEffect : UiEffect {
     ...
     * UI solo tenga que reenviarlo al [com.example.kortexgames.core.audio.AudioAndHapticManager].
     *
