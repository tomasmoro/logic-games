 ...
 * [com.kortexgames.app.core.mvi.MviViewModel]): el [Neon2048UiState]
...
sealed interface Neon2048Intent : UiIntent {
     ...
     *
     * Solo tiene efecto en [com.kortexgames.app.game.GameStatus.IDLE]: cambiar
...
sealed interface Neon2048Effect : UiEffect {
     ...
     * ([com.kortexgames.app.ui.components.FireworksOverlay]), más discreta
